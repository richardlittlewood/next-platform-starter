    ...
    return (
        <form name="registration" onSubmit={handleFormSubmit} className="flex flex-col gap-4 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="reg-name" className="block text-sm font-medium text-green-200 mb-1">Full Name *</label>
                    <input id="reg-name" name="name" type="text" placeholder="Dr. Jane Smith" required className="input w-full" />
                </div>
                <div>
                    <label htmlFor="reg-email" className="block text-sm font-medium text-green-200 mb-1">Email Address *</label>
                    <input id="reg-email" name="email" type="email" placeholder="jane.smith@example.com" required className="input w-full" />
                </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="reg-organisation" className="block text-sm font-medium text-green-200 mb-1">Organisation / Affiliation *</label>
                    <input id="reg-organisation" name="organisation" type="text" placeholder="University of..." required className="input w-full" />
                </div>
                <div>
                    <label htmlFor="reg-role" className="block text-sm font-medium text-green-200 mb-1">Role / Position</label>
                    <input id="reg-role" name="role" type="text" placeholder="e.g. Professor, Researcher" className="input w-full" />
                </div>
            </div>
            <div>
                <label htmlFor="reg-attendance" className="block text-sm font-medium text-green-200 mb-1">Preferred Attendance *</label>
            ...
            <div>
                <label htmlFor="reg-message" className="block text-sm font-medium text-green-200 mb-1">Additional Comments</label>
