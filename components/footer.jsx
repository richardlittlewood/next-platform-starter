export function Footer() {
    return (
        <footer className="bg-[#0a1225] py-12 sm:py-16">
                ...
                <div className="grid gap-8 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><a href="#about-sian" className="no-underline text-teal-200 hover:text-white transition-colors">About SIAN</a></li>
                            <li><a href="#about-meeting" className="no-underline text-teal-200 hover:text-white transition-colors">About the Meeting</a></li>
                            <li><a href="#programme" className="no-underline text-teal-200 hover:text-white transition-colors">Scientific Programme</a></li>
                            <li><a href="#faculty" className="no-underline text-teal-200 hover:text-white transition-colors">Faculty</a></li>
                            <li><a href="#registration" className="no-underline text-teal-200 hover:text-white transition-colors">Register Interest</a></li>
                        </ul>
                    </div>
                    <div>
