    ...
    return (
        <div className="flex flex-col gap-12 sm:gap-16">
            <section>
                ...
                <p className="text-lg text-[#4a5a3c] mb-6">
            ...
            <section>
                ...
                <div className="rounded-lg bg-white/60 border border-[#28371c]/10 p-8">
                    <p className="text-lg text-[#4a5a3c] italic">
            ...
            <section>
                ...
                <div className="grid gap-6 grid-cols-2 md:grid-cols-4">
                    <div className="text-center p-6 rounded-lg bg-white/60 border border-[#28371c]/10">
                        <p className="text-3xl font-bold text-accent mb-2">25+</p>
                        <p className="text-sm text-[#6b7b5c]">Years of Excellence</p>
                    </div>
                    <div className="text-center p-6 rounded-lg bg-white/60 border border-[#28371c]/10">
                        <p className="text-3xl font-bold text-accent mb-2">120+</p>
                        <p className="text-sm text-[#6b7b5c]">Faculty &amp; Researchers</p>
                    </div>
                    <div className="text-center p-6 rounded-lg bg-white/60 border border-[#28371c]/10">
                        <p className="text-3xl font-bold text-accent mb-2">3,500+</p>
                        <p className="text-sm text-[#6b7b5c]">Graduates</p>
                    </div>
                    <div className="text-center p-6 rounded-lg bg-white/60 border border-[#28371c]/10">
                        <p className="text-3xl font-bold text-accent mb-2">800+</p>
                        <p className="text-sm text-[#6b7b5c]">Published Studies</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="space-y-6 text-[#4a5a3c]">
